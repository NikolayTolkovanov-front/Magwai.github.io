...
// cards
var buttonToAddCards = document.querySelector(".btn-load-cards");
var cardsContainer = document.querySelector(".cards");
var cardImageWidth = "320";
var cardImageHeight = "185";
var limitCards = 30;
var cardsFromAPI = [];
var imagesFromApi = [];
var cards = [];
var countCards = 0;
function getImagesAndPosts() {
  return _getImagesAndPosts.apply(this, arguments);
}
function _getImagesAndPosts() {
  _getImagesAndPosts = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return getCardsInfo(cardsFromAPI);
        case 2:
          _context2.next = 4;
          return getImages(imagesFromApi);
        case 4:
        case "end":
...
function renderCard(currentCard) {
  ...
  var cardMetaAuthor = createNode("span");
  cardMetaAuthor.className = "cards-card__meta-author";
  cardMetaAuthor.innerHTML = " ".concat(currentCard.textContent.meta.author);
  append(cardsMeta, cardMetaAuthor);
  var metaPrefixDate = createNode("span");
  metaPrefixDate.className = "cards-card__meta-prefix";
  metaPrefixDate.innerHTML = ", ".concat(currentCard.textContent.meta.prefixDate);
  append(cardsMeta, metaPrefixDate);
  var cardMetaDate = createNode("span");
  cardMetaDate.className = "cards-card__meta-date";
  cardMetaDate.innerHTML = " ".concat(currentCard.textContent.meta.date);
  append(cardsMeta, cardMetaDate);
  var cardLinkContinue = createNode("a");
...
_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        _context.next = 2;
        return getImagesAndPosts();
      case 2:
        renderStartCards();
        buttonToAddCards.addEventListener("click", function () {
          if (countCards < limitCards) {
            for (var i = countCards; i < countCards + 5; i++) {
              var currentCard = {
                image: {
                  src: imagesFromApi[i].url,
                  alt: imagesFromApi[i].title,
